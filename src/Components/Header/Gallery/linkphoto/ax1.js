                    ...
                    <div className='info-box'>
                        <div className='info-box__one'>
                            ...
                            <div className='info-box__profile'>
                                <img src="https://media.karnaval.ir/members/2024/10/e9cd1f78-383f-422d-9a40-8d6e85dc1bf6.jpg?size=40x40" width={50} height={50} alt="profile" />
                                <p className='vz'>   محمد لاری </p>
                            </div>
                        </div>
                        ...
                        <div className='info-box__three'>
                            <div className='info-box__user-comment'>
                                {/* <img src="https://media.karnaval.ir/members/2024/10/ea35070c-6783-4125-bfd9-830d553ecce7.jpg?size=0x300"  width={50} height={50}  alt="profile"  /> */}
                                <div className='user-comment text-dark vz-bold'>
                                    {/* <p className='text-sky'>  محمد لاری </p> */}
