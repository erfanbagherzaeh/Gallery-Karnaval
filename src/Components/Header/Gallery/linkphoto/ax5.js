        ...
        <main>
            <section  >
                <div className='main-image'   >
                    <img   src="https://media.karnaval.ir/members/2024/10/5dfdaf1a-b36d-4640-8218-eb7b1f66bfef.jpg?size=0x300"   alt="baner"  />   
                </div>
            </section>
                    ...
                    <div className='info-box'>
                        <div className='info-box__one'>
                            <div className='info-box__title'>
                                <h3 className='vz-bold'> در کنار غروب دریا </h3>
                        ...
                        <div className='info-box__three'>
                            <div className='info-box__user-comment'>
                                ...
                                <div className='user-comment text-dark vz-bold'>
                                    ...
                                    <p> جایی که میتونید درارتفاع ساحل رو تماشا کنید </p>
                                </div>
                            </div>
