        ...
        <main>
            <section  >
                <div className='main-image'   >
                    <img   src=" https://media.karnaval.ir/members/2024/10/36d2f762-0c52-49e0-abc0-29c6491eefe9.jpg?size=0x300"   alt="baner"  />   
                </div>
            </section>
                    ...
                    <div className='info-box'>
                        <div className='info-box__one'>
                            ...
                            <div className='info-box__profile'>
                                <img src=" 	https://media.karnaval.ir/members/avatar/7.jpg?size=40x40" width={100} height={100} alt="profile" />
                                <p className='vz'>   علی ملکان   </p>
                            </div>
                        </div>
                        ...
                        <div className='info-box__three'>
                            <div className='info-box__user-comment'>
                                {/* <img src=" https://media.karnaval.ir/members/2024/10/36d2f762-0c52-49e0-abc0-29c6491eefe9.jpg?size=0x300"  width={50} height={50}  alt="profile"  /> */}
                                <div className='user-comment text-dark vz-bold'>
                                    {/* <p className='text-sky'>  علی ملکان   </p> */}
