        ...
        <main>
            <section  >
                <div className='main-image'   >
                    <img src="https://media.karnaval.ir/members/2024/10/581a6d92-4aae-49fc-9377-691c79f5a6e6.jpeg?size=0x300" alt="baner" />
                </div>
            </section>
                    ...
                    <div className='info-box'>
                        ...
                        <div className='info-box__three'>
                            <div className='info-box__user-comment'>
                                {/* <img src="https://media.karnaval.ir/members/2024/10/581a6d92-4aae-49fc-9377-691c79f5a6e6.jpeg?size=0x300" width={50} height={50} alt="profile" /> */}
                                <div className='user-comment text-dark vz-bold'>
                                    {/* <p className='text-sky'>  dani dirim   </p> */}
